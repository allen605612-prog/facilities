...
const cfgNoHakodate = {
  ...
  days: [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "返程A（省錢）：高速夜行バス 仙台/山形 → 東京（¥4,000–5,500，約7小時）★可省一晚旅館", star: true },
        { text: "返程B（快速）：山形新幹線 山形 → 東京（つばさ，¥18,340，約2.5小時）", star: false },
        { text: "抵東京成田/羽田轉機回台灣", star: false },
      ],
      stay: "—（返程）"
    },
  ],
  transport: [
    ["✈ 國內線（ANA/JAL外國人優惠票）", "東京(HND) → 青森(AOJ)", "¥10,800/人，約1小時（省¥6,670 vs 新幹線）"],
    ["機場巴士", "青森機場 → 弘前", "¥900/人，約55分鐘"],
    ["高速巴士（推薦省錢）", "青森 → 仙台", "¥3,000–4,000/人，約3.5小時"],
    ["仙山線", "仙台 → 山寺 → 山形", "IC卡 ¥1,720，各約1小時"],
    ["JR奧羽本線＋巴士", "山形 → 大石田 → 銀山温泉", "¥630 + ¥500，約1小時"],
    ["高速夜行バス（省錢返程）", "仙台/山形 → 東京", "¥4,000–5,500/人，約7小時"],
    ["租車", "Day 3–4（白神山地・奧入瀨）", "需備台灣國際駕照＋駕照正本"],
  ],
  transportNotes: [
    "本版不需購買 JR Pass（省¥25,000/人）：改以國內線＋高速巴士取代，每人交通費合計約¥20,000–22,000",
    "ANA Experience Japan Fare / JAL Explorer Pass：¥10,800固定/段，需在日本境外購票，憑外國護照搭乘",
    "夜行高速バス可省一晚旅館費，但車程約7–8小時；若不耐久坐可改山形新幹線→東京（¥18,340）",
  ...
  costs: [
    ...
    ["✈ 國內線 東京→青森（¥10,800）", "NT$ 2,500"],
    ["高速巴士（青森→仙台＋返程夜行）¥7,000–9,500", "NT$ 1,600–2,200"],
    ["IC卡・市內交通 ¥3,000", "NT$ 700"],
  ...
  totalCost: "約 NT$ 54,700–73,800（省 NT$4,300–5,000 vs 含JR Pass版）",
  notes: [
...
const cfgWithHakodate = {
  ...
  transport: [
    ["✈ 國內線（ANA/JAL外國人優惠票）", "東京(HND) → 函館(HKD)", "¥10,800/人，約1.5小時（省¥11,890！）"],
  ...
  transportNotes: [
    "本版最大省錢：飛機進函館（¥10,800）取代新幹線（¥22,690），每人省¥11,890，3人共省¥35,670",
    "ANA Experience Japan Fare / JAL Explorer Pass：¥10,800固定/段，需在日本境外購票，憑外國護照搭乘",
    "新函館北斗→新青森 仍需新幹線，建議點對點購票（¥9,500），不需買整個 JR Pass",
    "夜行高速バス（返程）可省一晚旅館費；若不耐可改仙台新幹線→東京（¥11,000）",
  ...
  totalCost: "約 NT$ 56,000–72,600（省 NT$5,200–6,200 vs 含JR Pass版）",
  notes: [
