...
const cfgNoHakodate = {
  ...
  days: [
    {
      ...
      items: [
        { text: "出發：台灣桃園機場飛東京成田/羽田（約3.5–4小時）", star: false },
        { text: "移動：東北新幹線 東京 → 新青森（はやぶさ，約3小時）", star: false },
        { text: "移動：奧羽本線 新青森 → 弘前（約40分鐘）", star: false },
    ...
    },
    {
      ...
      items: [
        ...
        { text: "上午：返回山形市・霞城公園（山形城遺址，歷史氛圍）", star: false },
        { text: "中午：山形新幹線 山形 → 東京（つばさ，約2.5小時）", star: false },
  ...
  transport: [
    ["東北新幹線（はやぶさ）", "東京 → 新青森", "JR Pass 涵蓋，約3小時"],
    ["奧羽本線", "新青森 → 弘前", "JR Pass 涵蓋，約40分"],
    ["東北新幹線", "新青森 → 仙台", "JR Pass 涵蓋，約1小時"],
    ["仙山線", "仙台 → 山寺 → 山形", "JR Pass 涵蓋，各約1小時"],
    ["山形新幹線（つばさ）", "山形 → 東京", "JR Pass 涵蓋，約2.5小時"],
    ["租車", "Day 3–4（白神山地・奧入瀨）", "需備台灣國際駕照＋駕照正本"],
    ["公車/計程車", "大石田站 → 銀山温泉", "約¥500–800/人（單程）"],
  ],
  transportNotes: [
    "推薦 JR Pass：JR東日本パス 東北エリア（6日間），約¥25,000/人",
    "（不需北海道範圍，比含函館版便宜約¥5,000/人）",
    "租車建議：弘前市租車行，日系車型，保險含碰撞。Day 3–4使用約¥8,000–12,000/天",
  ],
  hotels: [
  ...
  costs: [
    ["機票（台灣往返，轉東京）", "NT$ 18,000–28,000"],
    ["JR Pass（東北6日），約¥25,000", "NT$ 6,000–7,000"],
...
const cfgWithHakodate = {
  ...
  days: [
    {
      ...
      items: [
        { text: "出發：台灣桃園機場飛東京成田/羽田（約3.5–4小時）", star: false },
        { text: "移動：東北・北海道新幹線 東京 → 新函館北斗（はやぶさ，約4小時）", star: false },
        { text: "移動：道南いさりび鉄道 or 函館本線 新函館北斗 → 函館（約20分）", star: false },
  ...
  transport: [
    ["東北・北海道新幹線", "東京 → 新函館北斗", "JR Pass 涵蓋，約4小時"],
    ["道南いさりび鉄道", "新函館北斗 → 函館", "JR Pass 不涵蓋，約¥360/人"],
    ["東北・北海道新幹線", "新函館北斗 → 新青森", "JR Pass 涵蓋，約1小時"],
    ["奧羽本線", "新青森 → 弘前", "JR Pass 涵蓋，約40分"],
    ["東北新幹線", "新青森 → 仙台", "JR Pass 涵蓋，約1小時"],
    ["仙山線", "仙台 → 山寺 → 山形", "JR Pass 涵蓋，各約1小時"],
    ["山形新幹線（つばさ）", "山形 → 東京", "JR Pass 涵蓋，約2.5小時"],
  ...
  transportNotes: [
    "推薦 JR Pass：JR東日本・北海道パス（東北＋北海道），約¥30,000/人",
    "（道南いさりび鐵道不含 JR Pass，但費用極少，約¥360/人單程）",
    "租車建議：青森市租車行，Day 4–5使用約¥8,000–12,000/天",
  ],
  hotels: [
  ...
  costs: [
    ["機票（台灣往返，轉東京）", "NT$ 18,000–28,000"],
    ["JR Pass（東北＋北海道），約¥30,000", "NT$ 7,000–8,000"],
    ["住宿（6晚，均分3人）", "NT$ 16,000–24,000"],
    ["餐飲（每日約NT$1,500，含函館海鮮）", "NT$ 10,500"],
    ["租車（2天，均分3人）", "NT$ 2,500"],
    ["景點門票・雜費", "NT$ 2,000"],
  ],
  totalCost: "約 NT$ 56,000–75,000",
  notes: [
