...
const cfgNoHakodate = {
  ...
  days: [
    ...
    {
      title: "Day 5（7/5）青森市全日精華",
      items: [
        { text: "上午：WA-RASSE 睡魔祭博物館（互動展示，門票¥600/人）", star: false },
        { text: "上午：青森魚菜中心のっけ丼（代幣自選，現場挑配料）", star: true },
        { text: "下午：青森縣立美術館（奈良美智「青森犬」，門票¥510/人）", star: true },
        { text: "傍晚：A-FACTORY 蘋果工房（港邊，蘋果酒見學＋伴手禮購物）", star: false },
        { text: "傍晚：八甲田丸（青森港退役輪渡，外觀打卡）", star: false },
      ],
      stay: "Richmond Hotel 青森（第3晚）"
    },
    {
      title: "Day 6（7/6）八甲田山・酸ヶ湯温泉 ★ 本版亮點",
      items: [
        { text: "早晨：JR巴士 青森市 → 酸ヶ湯温泉（約1小時，¥1,250）", star: false },
        { text: "上午：八甲田ロープウェイ（山頂標高1,324m，夏季高山植物盛開，¥1,400/人）", star: true },
        { text: "上午：毛無岱・仙人沼高層濕原健行（木道步道，夏季杜鵑花與池塘倒影）", star: false },
        { text: "下午：酸ヶ湯温泉入浴（全國名湯百選，千人風呂，日本最古老溫泉之一）", star: true },
        { text: "傍晚：JR巴士返回青森市（約1小時）", star: false },
      ],
      stay: "Richmond Hotel 青森（第4晚）"
    },
    {
      title: "Day 7（7/7）青森 → 飛東京 → 回台灣",
      items: [
        { text: "早晨：青森市最後巡遊（棟方志功紀念館・三角公園土產採買）", star: false },
        { text: "上午：機場巴士 青森市 → 青森機場（¥740，約30分鐘）", star: false },
        { text: "中午：✈ 國內線 青森(AOJ) → 東京(HND)（ANA/JAL外國人優惠票，¥10,800，約1小時）", star: true },
  ...
  transport: [
    ...
    ["JR巴士（往返）", "青森市 ↔ 酸ヶ湯温泉・八甲田", "¥1,250/人往返，約1小時"],
    ["機場巴士", "青森市 → 青森機場", "¥740/人，約30分鐘"],
    ["✈ 國內線（ANA/JAL外國人優惠票）", "青森(AOJ) → 東京(HND)", "¥10,800/人，約1小時（返程）"],
    ["租車", "Day 3–4（白神山地・奧入瀨）", "需備台灣國際駕照＋駕照正本"],
  ],
  transportNotes: [
    "進出都走青森機場（AOJ），全程不需 JR Pass：兩段國內線¥21,600/人，每人交通費合計約¥22,000–25,000",
    "ANA Experience Japan Fare / JAL Explorer Pass：¥10,800固定/段，需在日本境外購票，憑外國護照搭乘",
    "青森機場（AOJ）ANA 直飛東京羽田（HND），每天約4班，Day 7注意班次時間以利轉機",
    "租車：弘前市租車行，日系車型，保險含碰撞。Day 3–4約¥8,000–12,000/天",
  ],
  hotels: [
    ["弘前（2晚）", "JR Inn 弘前", "近車站・新穎舒適", "¥15,000–20,000"],
    ["青森市（4晚）", "Richmond Hotel 青森", "大型連鎖・CP值高・近港", "¥18,000–25,000"],
  ],
  costs: [
    ["機票（台灣往返，轉東京羽田）", "NT$ 18,000–28,000"],
    ["✈ 國內線 東京→青森（進程 ¥10,800）", "NT$ 2,500"],
    ["✈ 國內線 青森→東京（返程 ¥10,800）", "NT$ 2,500"],
    ["機場巴士×2＋JR巴士八甲田 ¥3,640", "NT$ 840"],
    ["IC卡市內交通 ¥1,500", "NT$ 350"],
    ["住宿（6晚：弘前2＋青森4，均分3人）", "NT$ 9,300–13,900"],
    ["餐飲（每日約NT$1,200）", "NT$ 8,400"],
    ["八甲田ロープウェイ 3人", "NT$ 975"],
    ["租車（2天，均分3人）", "NT$ 2,500"],
    ["景點門票・雜費", "NT$ 2,000"],
  ],
  totalCost: "約 NT$ 47,000–60,000（全程青森進出，不需 JR Pass）",
  notes: [
...
const cfgWithHakodate = {
  ...
  days: [
    ...
    {
      title: "Day 6（7/6）青森市精華・A-FACTORY",
      items: [
        { text: "上午：WA-RASSE 睡魔祭博物館（互動展示，門票¥600/人）", star: false },
        { text: "上午：青森魚菜中心のっけ丼（代幣自選，現場挑配料）", star: true },
        { text: "下午：青森縣立美術館（奈良美智「青森犬」，門票¥510/人）", star: true },
    ...
    {
      title: "Day 7（7/7）八甲田山・酸ヶ湯 → 飛東京 → 回台灣",
      items: [
        { text: "早晨：JR巴士 青森市 → 酸ヶ湯温泉（約1小時，¥1,250）", star: false },
        { text: "上午：八甲田ロープウェイ（山頂標高1,324m，夏季高山植物盛開，¥1,400/人）", star: true },
        { text: "中午前：酸ヶ湯温泉入浴（全國名湯百選，千人風呂）", star: true },
        { text: "下午：JR巴士返回青森市，機場巴士 → 青森機場（¥740，約30分）", star: false },
        { text: "傍晚：✈ 國內線 青森(AOJ) → 東京(HND)（ANA/JAL外國人優惠票，¥10,800，約1小時）", star: true },
        { text: "夜間：東京成田/羽田轉機回台灣", star: false },
      ],
      stay: "—（返程）"
    },
  ],
  ...
  transportNotes: [
    "進出都走青森機場（AOJ），全程不需 JR Pass：進程飛函館省¥11,890，回程飛青森比仙台更方便",
    "ANA Experience Japan Fare / JAL Explorer Pass：¥10,800固定/段，需在日本境外購票，憑外國護照搭乘",
    "新函館北斗→新青森 仍需新幹線，點對點購票 ¥9,500，不需買整個 JR Pass",
    "青森機場（AOJ）ANA 直飛東京羽田（HND），Day 7 選傍晚班次，上午可遊八甲田",
  ...
  hotels: [
    ...
    ["青森市（3晚）", "Richmond Hotel 青森", "大型連鎖・CP值高・近港", "¥18,000–25,000"],
  ],
  costs: [
    ["機票（台灣往返，轉東京羽田）", "NT$ 18,000–28,000"],
    ...
    ["機場巴士×2＋JR巴士八甲田 ¥3,440", "NT$ 795"],
    ["IC卡市內交通 ¥2,000", "NT$ 463"],
    ["住宿（6晚：函館2＋弘前1＋青森3，均分3人）", "NT$ 13,200–19,700"],
    ["餐飲（每日約NT$1,500，含函館海鮮）", "NT$ 10,500"],
    ["八甲田ロープウェイ 3人", "NT$ 975"],
    ["租車（2天，均分3人）", "NT$ 2,500"],
    ["景點門票・雜費", "NT$ 2,000"],
  ],
  totalCost: "約 NT$ 57,000–63,000（全程青森進出，不需 JR Pass）",
  notes: [
