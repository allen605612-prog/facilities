...
# 三顆星：左小、右中、中大（頂部）
draw_star_3d(draw, 290, 155, 55, 22)   # 左
draw_star_3d(draw, 510, 160, 60, 24)   # 右
draw_star_3d(draw, 400,  95, 80, 32)   # 中（最大，最高）
...
# 「狂賀」
shadow_text(draw, "狂 賀", 240, f_crazy, GOLD_LIGHT)

# 學生姓名（兩行）
centered_text(draw, "高一心班宋彥霖、高一意班鐘宥昕", 318, f_names, OFF_WHITE)
centered_text(draw, "高一正班廖柃柃  同學", 372, f_names, OFF_WHITE)

# 分隔細線
draw.line([(80, 430), (W-80, 430)], fill=GOLD_DARK, width=1)

# 主要成就（金色大字）
shadow_text(draw, "榮獲第 66 屆第四區", 448, f_achiev, GOLD_LIGHT, shadow=(80,60,0))
shadow_text(draw, "分區高中科展", 518, f_achiev, GOLD_LIGHT, shadow=(80,60,0))
shadow_text(draw, "「環境學科」優等！", 588, f_achiev, GOLD_LIGHT, shadow=(80,60,0))
...
# ── 7. 底部感謝文字 ───────────────────────────────────────
centered_text(draw, "感謝 張祐誠 老師指導", 780, f_thanks, WHITE)
